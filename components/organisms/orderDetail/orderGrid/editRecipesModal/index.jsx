...
const EditRecipesModal = (props) => {
    ...
    const getTotalRecipesSelected = () => {
        return props.data.map((recipe) => recipe.quantity).reduce((prev, next) => prev + next, 0);
    };
    ...
    return (
        ...
        >
            ...
            {props.data.map((recipe) => (
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <Selector
                        ...
                        id={recipe.recipeId}
                        handleChange={props.handleEditRecipeQuantity}
            ...
            <Typography
                variant="subtitle1"
                color={disableSubmitButton() ? "textSecondary" : "primary"}
                style={{ fontSize: "14px", marginTop: theme.spacing(2) }}
            >
