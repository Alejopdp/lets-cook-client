...
const OrderGrid = (props) => {
    ...
    useEffect(() => {
        setRecipesSelection(recipesActualWeek.list)
    }, []);
    ...
    const handleEditRecipeQuantity = (recipeId, number) => {
        ...
        if (recipeToModify.quantitySelected === 0 && number < 0) {
            return false;
        } else {
    ...
    return (
        <>
            ...
            <EditRecipesModal
                ...
                recipesQuantity={recipesActualWeek.recipesQuantity}
            />
        </>
    );
};
