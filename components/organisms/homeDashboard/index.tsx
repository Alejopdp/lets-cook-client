...
export const HomeDashboard = ({ recipesList: responseRecipesList = [], filterList = [], hasError: hasRequestError, token }) => {
    // const _sortOptions = [
    //     {
    ...
    return (
        <>
            ...
            <TwoBoxesRow firstBox={<BarChartWithPaper title="Bar chart" />} secondBox={<LineChartWithPaper title="Line Chart" />} />
            <ThreeBoxesRow
